...
public class Population {
	...
	void PopulationEvolve(int step){
		...
		/* --- tworzenie populacji rozszerzonej T oraz O na podstawie metody ruletki */
		...
		System.out.println(" \n P: " + PopulationP.size() + " T: " + PopulationT.size() + " O: "  + PopulationO.size() + " Pp: " + PopulationPprim.size() );
	}
	...
	void sortMeduseList(ArrayList<Meduse> unsorted){
		...
		while(sortedMeduses < unsorted.size()){	//trzeba posortowaÊ KAØDY element, wiÍc petla iteruje po kaødym elemencie
			currentBestFitnessIndex=sortedMeduses;
			for(int ii=sortedMeduses ; ii<unsorted.size() ; ii++){	//znajdywanie najwiÍkszego eementu z zakresu od juø posortowanych do koÒca
