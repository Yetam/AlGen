...
public class Core {
	...
	public static void main(String[] args) throws InterruptedException {
		 ...
		 * 
		 * for(int i=0 ; i<1 ; i++){ p1.PopulationEvolve(i); } p1.PrintStats();
		 */

		// ... AAAALE NARAZIE TAMTO NIE DZIALA WIEC DZIALA TO - TO PO PROSTU
		// TWORZY JEDNA MEDUZE I JA ITERUJE
		...
		for (int i = 0; i < 5000000; i++) {
			...
			switch (i) {
			case 10000:
				// meduza.balls.get(1).momentum.setValues(0, -100); //nadawanie
				// ustalonych pędów; obsolete
				meduza.resetMeduse();
				break;
			}
